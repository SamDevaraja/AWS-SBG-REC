...
export const GamificationSidebar: React.FC<GamificationSidebarProps> = ({
  ...
  return (
    <div className="w-full xl:w-80 space-y-6 text-left">
      ...
      <div className="space-y-3">
        ...
        <div className="bg-slate-900/50 border border-slate-800/80 rounded-2xl p-4 space-y-3">
          {dailyQuests.map((quest) => (
            <div key={quest.id} className="flex items-center justify-between gap-3 text-xs animate-fade-in">
              <div className="flex items-start gap-2.5">
                <div className={cn(
                  "mt-0.5 w-[18px] h-[18px] rounded-md border flex items-center justify-center flex-shrink-0",
                  quest.done 
