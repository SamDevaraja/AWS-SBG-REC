...
export const RoadmapProgressUpdater: React.FC<RoadmapProgressUpdaterProps> = ({
  ...
  return (
    <div className={cn("bg-white border border-slate-200 rounded-3xl p-5 shadow-sm space-y-4 text-left", className)}>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-slate-50 border border-slate-100 rounded-2xl p-3 flex items-center gap-3">
          ...
          <div>
            <span className="text-[9px] font-semibold text-slate-400 uppercase block">Completed</span>
        ...
        <div className="bg-slate-50 border border-slate-100 rounded-2xl p-3 flex items-center gap-3">
          ...
          <div>
            <span className="text-[9px] font-semibold text-slate-400 uppercase block">XP Score</span>
            <span className="text-sm font-black text-slate-800">
              {xp} XP
            </span>
          </div>
        ...
        <div className="pt-2 border-t border-slate-100">
          {!showConfirmReset ? (
            <button
              ...
              className="text-[10px] font-bold text-rose-600 hover:text-rose-700 hover:underline flex items-center gap-1 transition-all cursor-pointer"
            >
            ...
            <div className="flex items-center justify-between bg-rose-50 border border-rose-100 rounded-2xl p-3">
              ...
              <div className="flex gap-2">
                <button
                  onClick={handleReset}
                  className="bg-rose-600 hover:bg-rose-700 text-white font-bold text-[9px] px-2.5 py-1 rounded-lg shadow-sm cursor-pointer"
                >
                  Yes, Reset
                </button>
                <button
                  onClick={() => setShowConfirmReset(false)}
                  className="bg-white border border-slate-200 text-slate-600 font-bold text-[9px] px-2.5 py-1 rounded-lg cursor-pointer"
                >
                  Cancel
                </button>
              </div>
