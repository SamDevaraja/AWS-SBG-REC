    ...
    >
      ...
      >
        ...
        <svg viewBox="0 0 180 140" className="w-72 h-56 absolute bottom-6 drop-shadow-xl pointer-events-none">
          ...
          <path 
            d="M 25,90 L 155,90 L 135,118 L 90,135 L 45,118 Z" 
          ...
          {/* 2. GRASS LAYER */}
          <ellipse cx="90" cy="90" rx="68" ry="18" fill="#065F46" />
    ...
    >
      ...
      >
        <svg viewBox="0 0 180 140" className="w-80 h-64 absolute bottom-6 drop-shadow-xl pointer-events-none">
          ...
          <path 
            d="M 20,85 L 160,85 L 138,118 L 90,138 L 42,118 Z" 
            fill="url(#beg-rock-grad)"
            stroke="#1E293B"
            strokeWidth="1.5"
          ...
          <path d="M 10,88 C 10,78 30,74 50,74 C 70,74 85,79 100,74 C 115,74 130,79 145,79 C 160,79 160,88 150,92 C 140,96 120,98 105,98 C 95,100 70,100 50,98 C 30,100 10,96 10,88 Z" fill="#FFFFFF" opacity="0.9" />
        </svg>
        ...
        <div className="absolute top-2 flex flex-col items-center">
          <motion.div
            className={cn(
              "w-12 h-12 rounded-full flex items-center justify-center shadow-lg border relative transition-all duration-300",
              locked 
                ? "bg-slate-100/90 border-slate-300 text-slate-450" 
                : "bg-gradient-to-br from-orange-500 to-orange-600 border-white text-white shadow-orange-500/20"
            )}
            animate={!locked ? { scale: [1, 1.08, 1] } : {}}
            transition={{ duration: 3, repeat: Infinity }}
          >
        ...
        <div className={cn(
          ...
          <p className={cn(
            ...
            locked ? "text-slate-350" : "text-orange-100"
          )}>
    ...
    >
      ...
      >
        <svg viewBox="0 0 180 140" className="w-80 h-64 absolute bottom-6 drop-shadow-2xl pointer-events-none">
          ...
          {/* 1. FLOATING ROCK BASE */}
          <path 
            d="M 20,85 L 160,85 L 135,118 L 90,138 L 45,118 Z" 
        ...
        <div className={cn(
          ...
          {locked ? (
            ...
            <div className="absolute -top-2 -right-2 bg-amber-500 border-2 border-white text-white p-1 rounded-full shadow-md animate-bounce">
              <Icons.PartyPopper className="w-3.5 h-3.5 stroke-[2.5]" />
            </div>
          )}
        </div>
      </motion.div>
