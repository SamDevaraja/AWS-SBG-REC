...
import type { Task, Comment, Activity, TaskStatus, Priority, TaskCategory } from '@/lib/workspace-types';
import { CATEGORIES, PRIORITIES, STATUSES } from '@/lib/workspace-types';
