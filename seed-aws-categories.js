// Seed AWS Service Categories into the EventRegistration database
// Run with: node seed-aws-categories.js
...
async function main() {
  ...
  for (const cat of seedCategories) {
    await prisma.aWSServiceCategory.upsert({
      where: { slug: cat.slug },
  ...
  console.log(`\nSuccessfully seeded ${seedCategories.length} categories!`);
}
